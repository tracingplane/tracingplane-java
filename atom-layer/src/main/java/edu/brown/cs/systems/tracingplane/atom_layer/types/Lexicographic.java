...
public class Lexicographic {
    ...
    /** Write a 32 bit signed integer value into the provided buffer, encoded as a lexicographically comparable
     * varint */
    public static int writeVarInt32(ByteBuffer buf, int value) {
        return SignedLexVarint.writeLexVarInt32(buf, value);
    }

    /** Write a 64 bit signed integer value into the provided buffer, encoded as a lexicographically comparable
     * varint */
    public static int writeVarInt64(ByteBuffer buf, long value) {
        return SignedLexVarint.writeLexVarInt64(buf, value);
    }

    /** Write a 32 bit unsigned integer value into the provided buffer, encoded as a lexicographically comparable
     * varint */
    public static int writeVarUInt32(ByteBuffer buf, int value) {
        return UnsignedLexVarint.writeLexVarUInt32(buf, value);
    }

    /** Write a 64 bit unsigned integer value into the provided buffer, encoded as a lexicographically comparable
     * varint */
    ...
    /** Returns the byte representation of the provided 32 bit unsigned integer encoded as a lexicographically
     * comparable varint */
    ...
    /** Returns the byte representation of the provided 64 bit unsigned integer encoded as a lexicographically
     * comparable varint */
