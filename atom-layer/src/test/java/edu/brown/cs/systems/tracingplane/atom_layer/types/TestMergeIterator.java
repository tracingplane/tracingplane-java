...
public class TestMergeIterator extends TestCase {
	...
	public void testMergeIterator() {
		...
		MergeIterator<Integer> merged = new MergeIterator<Integer>(
				Lists.<Iterator<Integer>>newArrayList(evens.iterator(), odds.iterator()), integerComparator);
		...
		merged = new MergeIterator<Integer>(
				Lists.<Iterator<Integer>>newArrayList(odds.iterator(), evens.iterator()), integerComparator);
	...
	public void testMergeIterator2() {
		...
		MergeIterator<Integer> merged = new MergeIterator<Integer>(
				Lists.<Iterator<Integer>>newArrayList(tens.iterator(), twenties.iterator()), integerComparator);
		...
		// Same test, reverse order
		merged = new MergeIterator<Integer>(
				Lists.<Iterator<Integer>>newArrayList(twenties.iterator(), tens.iterator()), integerComparator);
	...
	public void testMergeDuplicates() {
		...
		MergeIterator<Integer> merged = new MergeIterator<Integer>(
				Lists.<Iterator<Integer>>newArrayList(a.iterator(), a.iterator()), integerComparator);
	...
	public void testMultipleEmptyIteratorsPlusOne() {
		...
		List<Integer> empty = Lists.newArrayList();
		List<Iterator<Integer>> iterators = Lists.newArrayList(empty.iterator(), empty.iterator(), list.iterator(), empty.iterator());
		MergeIterator<Integer> merged = new MergeIterator<Integer>(iterators, integerComparator);
