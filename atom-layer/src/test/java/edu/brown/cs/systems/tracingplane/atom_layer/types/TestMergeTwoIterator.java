...
public class TestMergeTwoIterator extends TestCase {
	...
	public void testMergeIterator() {
		...
		MergeTwoIterator<Integer> merged = new MergeTwoIterator<Integer>(evens.iterator(), odds.iterator(),
				integerComparator);
	...
	public void testMergeIterator2() {
		...
		MergeTwoIterator<Integer> merged = new MergeTwoIterator<Integer>(tens.iterator(), twenties.iterator(), integerComparator);
	...
	public void testMultipleEmptyIterators() {
		...
		MergeTwoIterator<Integer> merged = new MergeTwoIterator<Integer>(empty.iterator(), empty.iterator(), integerComparator);
		assertFalse(merged.hasNext());
	}
	...
	public void testEmptyIteratorPlusOne() {
		...
		List<Integer> empty = Lists.newArrayList();
		MergeTwoIterator<Integer> merged = new MergeTwoIterator<Integer>(empty.iterator(), list.iterator(), integerComparator);
