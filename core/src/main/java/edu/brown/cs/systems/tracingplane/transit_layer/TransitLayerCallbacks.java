...
public class TransitLayerCallbacks {
    ...
    /**
     * Manages user-supplied {@link BaggageListeners} that intercept invocations of {@link TransitLayer} functions
     * 
     * Users can register {@link BaggageListeners} instances that specify additional logic to invoke whenever executions
     * branch and join.
     * 
    ...
    public static class TransitLayerCallbackRegistry<B extends Baggage> {
         ...
         * {@link BaggageListeners#join(Baggage, Baggage, BiFunction)} for all registered handlers, which may decorate or
