...
import brown.tracingplane.BaggageListeners.BranchListener;
import brown.tracingplane.BaggageListeners.DiscardListener;
import brown.tracingplane.BaggageListeners.JoinListener;
import brown.tracingplane.BaggageListeners.NewInstanceListener;
import edu.brown.cs.systems.tracingplane.transit_layer.Baggage;

/**
 * <p>
 * A {@link BaggageProvider} provides the implementation of {@link BaggageContext} objects that get propagated within
 * systems. A process only has one global {@link BaggageProvider} implementation, which is configured by setting the
 * <code>baggage.provider</code> property.
 * </p>
 */
public interface BaggageProvider<B extends BaggageContext> {
    ...
    /**
     * Register a {@link NewInstanceListener} to be invoked whenever new baggage instances are created.
     * @param listener a {@link NewInstanceListener}
     */
    public void postNewInstance(NewInstanceListener<B> listener);
    
    /**
     * Register a {@link DiscardListener} to be invoked whenever new baggage instances are discarded.
     * @param listener a {@link DiscardListener}
     */
    public void preDiscard(DiscardListener<B> listener);
    
    /**
     * Register a {@link BranchListener} to be invoked whenever baggage instances are branched.
     * @param listener a {@link BranchListener}
     */
    public void onBranch(BranchListener<B> listener);
    
    /**
     * Register a {@link JoinListener} to be invoked whenever baggage instances are joined.
     * @param listener a {@link JoinListener}
     */
    public void onJoin(JoinListener<B> listener);
}
