...
/**
 * Adapted from Guava's com.google.common.primitives.UnsignedBytes to provide comparators
 * for unsigned ByteBuffers
 */
public final class UnsignedByteBuffer {
  ...
  /**
   * Returns a comparator that compares two {@code java.nio.ByteBuffer}s <a
